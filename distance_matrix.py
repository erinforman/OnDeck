...
def get_next_trip(user_id, origin_place_id, excluded_destinations):
    ...
    try:
        next_trip =  db.session.query(
            ...
            attrc_1.url_img.label('url_img_1'),
            attrc_1.url_title.label('url_title_1'),
            attrc_1.url_head_title.label('url_head_title_1'),
            attrc_1.url_author.label('url_author_1'),
            attrc_1.url_site_name.label('url_site_name_1'),
            attrc_1.url_twitter.label('url_twitter_1'),
            ...
            attrc_2.url_site_name.label('url_site_name_2'),
            attrc_2.url_twitter.label('url_twitter_2'), 
            loc_2.business_name.label('business_name_2'),
            loc_2.formatted_address.label('formatted_address_2'),
