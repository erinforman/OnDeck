...
function showResults(results) {
  ...
  if (results[0] === 'need_more_time' || results[3] === 0) {
    ...
    // Allows new itinerary details to generate without appending to a previous itinerary.
    $("#legs").empty();
    ...
    $('#legs').append(`
      ...
      <div id=itinerary_destination_urlhyper_0 style= 'display: inline-block; padding: 5px;'></div><a href= '${results[1][0][3]}'>${url_display_text} </a> - ${source_display_text}
      <br>
      ...
      $.each( results[1].slice(1), function( i,l ){
        ...
        $('#legs').append(`
          ...
          <div id=itinerary_destination_urlhyper_${i} style= 'display: inline-block; padding: 5px;'></div><a href= '${l[3]}'>${url_display_text} </a> - ${source_display_text}
          <br>
